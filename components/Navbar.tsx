  ...
  return (
    <header className="relative">
      ...
      <div
        className={`${
          !open && 'hidden '
        } fixed h-screen w-full bg-[#121316] text-[#696F7D] z-20`}
      >
        <div className="text-[#E5E6E9]">
          <XMarkIcon
            onClick={() => setOpen(false)}
            className="h-12 w-12 absolute top-2 right-2 cursor-pointer z-30"
          />
        </div>
        <div className="flex h-full flex-col gap-14 py-11 px-8">
          <ul>
